    ...
    <div id="card-info" className="mx-1 my-[0.375rem]">
      ...
      >
        <div className="flex flex-row justify-between">
          ...
          <EditableContent>
            <span className="pt-1 font-medium text-muted-foreground">
              56 bids
            </span>
          </EditableContent>
        </div>
        <div className="flex flex-row items-start justify-between font-medium text-muted-foreground">
          <EditableContent>
            <span>$69.40 shipping</span>
          </EditableContent>
          <EditableContent>
            <span className="pt-1 text-muted-foreground">5d 20h</span>
          </EditableContent>
        </div>
